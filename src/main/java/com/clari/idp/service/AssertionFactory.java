package com.clari.idp.service;

import com.clari.idp.attributes.AttributeConverter;
...
final class AssertionFactory {
    static Assertion buildAssertion(com.clari.idp.model.AuthnRequest input, DateTime authenticationTime) throws MarshallingException, SignatureException {
    ...
    private static Issuer buildIssuer(com.clari.idp.model.AuthnRequest input) {
        Issuer issuer = new IssuerBuilder().buildObject();
        issuer.setValue(input.issuer);
        return issuer;
    }

    private static AttributeStatement buildAttributeStatement(com.clari.idp.model.AuthnRequest input) {
    ...
    private static AuthnStatement buildAuthnStatement(com.clari.idp.model.AuthnRequest input, DateTime authenticationTime) {
    ...
    private static Conditions buildConditions(com.clari.idp.model.AuthnRequest input) {
    ...
    private static Subject buildSubject(com.clari.idp.model.AuthnRequest input, DateTime authenticationTime) {
